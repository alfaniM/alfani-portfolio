  ...
  return (
    <nav ref={nr} className={`navbar navbar-expand-lg change ${theme === "themeL" ? "light" : ""}`}>
      <div className="container">
        <Link href="/">
          <a className="logo">{theme ? theme === "themeL" ? <img ref={lr} src={`${appData.darkLogo}`} alt="logo" /> : <img ref={lr} src={`${appData.lightLogo}`} alt="logo" /> : <img ref={lr} src={`${appData.lightLogo}`} alt="logo" />}</a>
        </Link>
